...
const CircularGallery: React.FC<CircularGalleryProps> = ({
  ...
  const experiences = [
    {
      ...
      description: "Selected performer supporting live-field coordination for national broadcast event.",
    ...
    },
    {
      ...
      description: "Represented the College through campus tours and student recruitment.",
    ...
    },
    {
      ...
      description: "Awarded top performance in national cybersecurity engineering competition.",
    ...
    },
    {
      ...
      description: "Hands-on experience in engineering systems and project management.",
    ...
    },
    {
      ...
      description: "Cultural and academic immersion experience after two years in Honors College.",
  ...
  const calculatePosition = (index: number, total: number) => {
    ...
    const bendFactor = bend * (1 + Math.sin(scrollProgress * Math.PI * 2) * 0.5);
    ...
    >
      ...
      {experiences.map((exp, index) => {
        ...
        return (
          <div
            key={exp.id}
            className={`gallery-card-moving ${index === activeIndex ? 'card-active' : ''}`}
            style={{
